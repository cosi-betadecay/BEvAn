...
from physics.preprocessing.arm import arm_preprocessing
...
def preprocesser(energies: torch.Tensor, positions: torch.Tensor, sigma: float) -> bool:
    ...
    new_energies_v3, new_positions_v3 = arm_preprocessing(new_energies_v2, new_positions_v2)
    new_energies_v4, new_positions_v4 = mid_preprocessing(new_energies_v3, new_positions_v3)

    return new_energies_v4, new_positions_v4
