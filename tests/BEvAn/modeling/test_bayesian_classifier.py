...
def test_decision_rule_at_count_prior() -> None:
    """Decide β⁺ vs background at the log-ratio cut set by the count prior."""
...
def test_decision_rule_degenerate_priors_and_nan() -> None:
    """Handle zero-count priors and NaN log-ratios in the decision rule."""
