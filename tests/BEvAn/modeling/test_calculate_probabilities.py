...
def test_log_R_sums_term_log_ratios():
    terms = [
...
def test_confusion_counts_tallies_and_excludes_nan():
...
def test_confusion_counts_no_terms_decides_on_prior_alone():
...
def test_log_confusion_noop_without_wandb_run():
